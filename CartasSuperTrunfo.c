...
scanf("%f", &PIB1);
printf("Infome a Area da cidade 1:\n");
scanf("%f", &Area1);
...
scanf("%f", &PIB2);
printf("Infome a Area da cidade 2:\n");
scanf("%f", &Area2);
  ...
  printf("Estado: %s\n"
        ...
        "PIB: %f\n"
        "Area da Cidade: %f\n",
        Estado1, Codigo1, Cidade1, Populacao1, Tour1, PIB1, Area1);
 ...
 // EXIBINDO INFORMAÇÕES DA CARTA 2:
  ...
  printf("Estado: %s\n"
        ...
        "PIB: %f\n"
        "Area da Cidade: %f\n",
        Estado2, Codigo2, Cidade2, Populacao2, Tour2, PIB2, Area2);
